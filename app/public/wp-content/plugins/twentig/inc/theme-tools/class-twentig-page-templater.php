...
class Twentig_Page_Templater {
	...
	private function __construct() {
		...
		$this->templates = array(
			'tw-no-title.php'                 => _x( 'Twentig - No title', 'page template name', 'twentig' ),
			'tw-no-header-footer.php'         => _x( 'Twentig - No header, no footer', 'page template name', 'twentig' ),
			'tw-header-transparent.php'       => _x( 'Twentig - Transparent header', 'page template name', 'twentig' ),
			'tw-header-transparent-light.php' => _x( 'Twentig - Transparent header light', 'page template name', 'twentig' ),
		);
